...
@app.cell
def _(pl):
    csv_file = '../data/csv_data/saf_relax-dmi=0.6-8_ku=0.08.csv'
    ...
    df.write_csv('../data/csv_data/saf_relax-dmi=0.6-8_ku=0.08-labeled.csv')
    df2 = df.with_columns(
    ...
    df2.write_csv('../data/csv_data/saf_relax-dmi=0.6-8_ku=0.08-multi-labeled.csv')
    return (df2,)
